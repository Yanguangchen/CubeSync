...
| `window.CubeSyncMetrics` | `cubesync-metrics.js` | Operational metrics dashboard helpers — daily/weekly/monthly counts, average forms per day, peak periods, processed records, manual-review records |
