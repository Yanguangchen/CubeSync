...
describe("sw.js", () => {
  ...
  test("date-of-test-from-age release invalidates the cubesync-v16 app shell", () => {
    assert.doesNotMatch(swContent, /CACHE_NAME = "cubesync-v16"/);
  });

  test("testing-team lock release invalidates the cubesync-v17 app shell", () => {
    assert.doesNotMatch(swContent, /CACHE_NAME = "cubesync-v17"/);
  });

  test("age-based set numbering release invalidates the cubesync-v18 app shell", () => {
    assert.doesNotMatch(swContent, /CACHE_NAME = "cubesync-v18"/);
  });

  test("dashboard split-by-set release invalidates the cubesync-v19 app shell", () => {
    assert.doesNotMatch(swContent, /CACHE_NAME = "cubesync-v19"/);
  });

  test("remember-form-details release invalidates the cubesync-v20 app shell", () => {
    assert.doesNotMatch(swContent, /CACHE_NAME = "cubesync-v20"/);
  });

  test("restricted supplier list release invalidates the cubesync-v21 app shell", () => {
    assert.doesNotMatch(swContent, /CACHE_NAME = "cubesync-v21"/);
  });

  test("local form history release invalidates the cubesync-v22 app shell", () => {
  ...
  test("RPA queue split-by-set release invalidates the cubesync-v24 app shell", () => {
    assert.doesNotMatch(swContent, /CACHE_NAME = "cubesync-v24"/);
  });

  test("date-of-cast follow-up release invalidates the cubesync-v25 app shell", () => {
    assert.doesNotMatch(swContent, /CACHE_NAME = "cubesync-v25"/);
  });
